...
# Greedy Interventional Equivalance Search Algorithm
class GIES(DiscoveryMethodModel):
    """
    Greedy Interventional Equivalence Search (GIES) algorithm for causal discovery.

    This class implements the GIES algorithm, which is used to discover causal graphs from data.
    ...
    def create_graph_from_data(self, dataset: Dataset):
        """
        Creates a causal graph from the given dataset using the GIES algorithm.
